...
public interface ExerciseDao {
    ...
    @Query("SELECT * FROM exercises WHERE category = :category AND type = :type ORDER BY name ASC")
    LiveData<List<Exercise>> getByCategoryAndType(String category, String type);
